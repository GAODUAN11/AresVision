...
const en = {
  ...
  explore: {
    ...
    pageDesc: 'Data Management is for uploading MCD, OpenMARS, and NOMAD raw datasets. User uploads serve Data Overview visualization only; training and prediction use datasets maintained by admins on the server.',
    stepUploadTitle: 'Upload Datasets',
    stepUploadDesc: 'Upload MCD, OpenMARS, or NOMAD `.nc` files. The system identifies dataset type, Mars year, Ls range, and grid structure.',
    ...
    upload: {
      ...
      subtitle: 'Supports MCD, OpenMARS, and NOMAD (.nc) formats. The system validates type, Mars year, Ls range, variables, and grid compatibility for Data Overview visualization.',
    ...
    myData: {
      ...
      ingestDesc: 'This page manages raw uploads for Data Overview visualization. Training and prediction use server-managed datasets instead of user-uploaded personal fusion data.',
      ingestCheck1: 'Type detection',
      ingestCheck2: 'Grid validation',
      ingestCheck3: 'Overview-ready source',
      statUploads: 'Uploads',
  ...
  predict: {
    ...
    shapleyBtn: '🧠 View Global Gradient Attribution',
    horizonMetrics: {
    ...
    toggleShapley: 'Shapley contribution',
    shapleyTitle: 'Feature contribution analysis',
    shapleyDesc: 'Estimate the marginal gain brought by each meteorological feature using Shapley values from game theory.',
    shapleyGenerateBtn: 'Analyze feature contribution',
    ...
    shapleyMarginalBtn: '🧬 Marginal Contribution Analysis',
    shapleyGeneratingBtn: 'Computing Feature Attribution...',
    barChart: {
    ...
    shapley: {
      ...
      gradientSystem: 'Gradient Attribution',
      marginalSystem: 'Marginal Contribution',
      gradientTab: 'Gradient',
      marginalTab: 'Marginal',
      cacheMissing: 'Cache Miss',
      cacheMissingDesc: 'The Shapley marginal contribution for this metric requires a fresh traversal...',
      importanceTitle: 'Feature Importance',
      meanShap: 'Mean Attribution Value',
      swarmTitle: 'Summary Swarm Plot',
      impactOnPred: 'Impact on Prediction',
      marginalAnalysisTitle: 'Marginal Contribution',
      ...
      footerNote: 'Calculated on test set samples • Red and blue dots represent high and low raw feature values\nThis view makes model decision logic more transparent.',
      featureValue: 'Feature Value',
    },
    shap: {
      computing: 'Computing attribution...',
      waterfallTitle: 'Waterfall Attribution',
      waterfallDesc: 'Stepwise attribution from the baseline value to the final prediction.',
