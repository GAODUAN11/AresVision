...
sys.stdout = Logger(os.path.join(base_dir, "models", "training_logs", "UVST.txt"))
...
checkpoint_path = os.path.join(base_dir, "models", "training_results", "early_stop_checkpoint.pth")
...
def plot_spatial_modulation(W, B, K, base_dir, var_name="Variable"):
    ...
    save_path = os.path.join(base_dir, "models", "training_results", save_filename)
...
def plot_zonal_mean_error(true, pred_s, pred_l, base_dir):
    ...
    plt.tight_layout()
    save_path = os.path.join(base_dir, "models", "training_results", "Zonal_Mean_Error.png")
...
try:
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(base_dir, "models", "training_results", "O3_Scatter_Plot_UVST.png"), dpi=300)
    plt.show()
except Exception as e:
    print(f"高质量绘图失败: {e}")

torch.save(model.state_dict(), os.path.join(base_dir, "models", "training_results", "predrnn_highlat_gpu_UVST.pth"))
...
try:
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(base_dir, "models", "training_results", "PFI_Analysis_Fixed.png"))
