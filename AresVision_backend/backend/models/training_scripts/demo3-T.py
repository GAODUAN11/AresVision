...
sys.stdout = Logger(os.path.join(base_dir, "models", "training_logs", "T.txt"))
...
active_vars = [c for c in "T" if c in mcd_vars_map]
...
save_path = args.output_path or os.path.join(base_dir, "models", "training_results", "predrnn_T.pth")
