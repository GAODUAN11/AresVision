...
sys.stdout = Logger(os.path.join(base_dir, "models", "training_logs", "baseline.txt"))
...
save_path = args.output_path or os.path.join(base_dir, "models", "training_results", "predrnn_baseline.pth")
